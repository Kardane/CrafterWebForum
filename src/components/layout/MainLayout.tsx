...
export default function MainLayout({ children }: MainLayoutProps) {
	...
	const showHeader = !isAuthPage && !isLandingPage && !isPostDetailPage && !isComposerPage;
		...
		<div className="min-h-screen bg-bg-primary text-text-primary font-sans flex text-sm md:text-base">
			...
			<div className={classNames(
				...
				<main className={classNames(
					"flex-1",
					{
						"px-4 pb-4 pt-2 md:px-6 md:pb-6 md:pt-4": !isAuthPage && !isLandingPage && !isPostDetailPage && !isComposerPage,
